...
static const char *Head0[] = {
    ...
    "	#else",
    "		#define VECTORSZ	4112	/* the formula causes probs in "
    "preprocessing */",
    "	#endif",
    "#else",
    "	#ifndef VECTORSZ",
...
static const char *Header[] = {
    ...
    "			#define CNTRSTACK", /* => !NOREDUCE && BITSTATE &&
                                               SAFETY && WS<=4 */
    "		#else",
    ...
    "	#define HC4",
    "#endif",
    "#if defined(HC0) || defined(HC1) || defined(HC2) || defined(HC3) || "
    "defined(HC4)",
    "	#define HC	4", /* 2x32 bits */
    "#endif",               /* really only one hashcompact mode, not 5 */
    "",
    "struct _Stack  {	 /* for queues and processes */",
    "#if VECTORSZ>32000",
    "	int o_delta;",
    "	#ifndef TRIX",
    "		int o_offset;",
    ...
    "	struct _Stack *lst;",
    "} _Stack;\n",
    "struct Svtack { /* for complete state vector */",
    "#if VECTORSZ>32000",
    "	int o_delta;",
    "	int m_delta;",
    "#else",
...
static const char *R7b[] = {
    ...
    "	case 1:	/* addproc */",
    "#if VECTORSZ>32000",
    "		memcpy((char *) P_o_tmp, (const char *) proc_offset, "
    "MAXPROC*sizeof(int));",
    "#else",
    "		memcpy((char *) P_o_tmp, (const char *) proc_offset, "
    "MAXPROC*sizeof(short));",
    "#endif",
    "		memcpy((char *) P_s_tmp, (const char *) proc_skip, "
    "MAXPROC*sizeof(uchar));",
    "		proc_offset = P_o_tmp;",
    "		proc_skip   = (uchar *) &P_s_tmp[0];",
    "		break;",
    "	case 2: /* addqueue */",
    "#if VECTORSZ>32000",
    "		memcpy((char *) Q_o_tmp, (const char *) q_offset, "
    "MAXQ*sizeof(int));",
    "#else",
    "		memcpy((char *) Q_o_tmp, (const char *) q_offset, "
    "MAXQ*sizeof(short));",
    "#endif",
    "		memcpy((char *) Q_s_tmp, (const char *) q_skip, "
    "MAXQ*sizeof(uchar));",
    "		q_offset = Q_o_tmp;",
    ...
    "	case 1: /* addproc */",
    "	#if VECTORSZ>32000",
    "		bfs_swoosh(&bfs_save_po, (char **) &proc_offset, "
    "MAXPROC*sizeof(int));",
    "	#else",
    "		bfs_swoosh(&bfs_save_po, (char **) &proc_offset, "
    "MAXPROC*sizeof(short));",
    "	#endif",
    "		bfs_swoosh(&bfs_save_ps, (char **) &proc_skip, "
    "MAXPROC*sizeof(uchar));",
    "		break;",
    "	case 2: /* addqueue */",
    "	#if VECTORSZ>32000",
    "		bfs_swoosh(&bfs_save_qo, (char **) &q_offset, "
    "MAXQ*sizeof(int));",
    "	#else",
    "		bfs_swoosh(&bfs_save_qo, (char **) &q_offset, "
    "MAXQ*sizeof(short));",
    "	#endif",
    "		bfs_swoosh(&bfs_save_qs, (char **) &q_skip, "
    "MAXQ*sizeof(uchar));",
    "		break;",
    "	case 3: /* do nothing */",
    "		break;",
...
const char *R13_[] = {
    ...
    "		#ifdef V_TRIX",
    "			printf(\"%%4d: channel %%d s restore %%p into "
    "%%d\\n\",",
...
const char *R14_[] = {
    ...
    "		#ifdef V_TRIX",
    "			printf(\"%%4d: channel %%d r restore %%p into "
    "%%d\\n\",",
...
static const char *Proto[] = {
    ...
    "!defined(SPACE) && !defined(USE_TDH) && NCORE==1",
    "	#define AUTO_RESIZE",
    "#endif",
    "",
    "struct Trail Trail;",
    ...
    "	#ifdef FULLSTACK",
    "		unsigned int tagged;",
    "		#if defined(BITSTATE) && !defined(NOREDUCE) && "
    "!defined(SAFETY)",
    ...
    "	#ifdef BCS",
    "		#ifndef CONSERVATIVE",
    "			#define CONSERVATIVE	1 /* good for up to 8 "
    "processes */",
    "		#endif",
    "		#ifdef CONSERVATIVE",
    "			#if CONSERVATIVE <= 0 || CONSERVATIVE>32",
    "			#error sensible values for CONSERVATIVE are 1..32 "
    "(256/8 = 32)",
    "			#endif",
    "			uchar ctx_pid[CONSERVATIVE];", /* pids setting lowest
                                                          value */
    "		#endif",
    "		uchar ctx_low;", /* lowest nr of context switches seen so far */
    "	#endif",
    "	#if NCORE>1",
    "		/* could cost 1 extra word: 4 bytes if 32-bit and 8 bytes if "
    "64-bit */",
    "		#ifdef V_PROVISO",
    "			uchar	cpu_id;		/* id of cpu that created the "
    "state */",
    "		#endif",
    "	#endif",
    "	#ifdef COLLAPSE",
    ...
    "	struct EV_Hold {",
    "	 #if !defined(BFS_PAR) || (!defined(NOCOMP) && !defined(HC) && "
    "NRUNS>0)",
    "		char *sv;	/* Mask */",
    "	 #endif",
    "	 #if VECTORSZ<65536",
