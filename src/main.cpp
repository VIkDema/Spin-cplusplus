...
void setaccess(Symbol *sp, Symbol *what, int cnt, int t) {
  Access *a;
...
Lextok *rem_var(Symbol *a, Lextok *b, Symbol *c, Lextok *ndx) {
  Lextok *tmp1;
...
void explain(int n) {
  ...
  case GE:
    ...
    break;
  case GET_P:
    fprintf(fd, "%sget_priority", Function);
    break;
  case GOTO:
  ...
  case ARROW:
    ...
    break;
  case SET_P:
    fprintf(fd, "%sset_priority", Function);
    break;
  case SHOW:
